...
<p><spring:message code="registration.doctorProf.advice"/></p>
    ...
    <form:form modelAttribute="professional" method="POST" action="${doctorProfile}" enctype="multipart/form-data" accept-charset="ISO-8859-1" id="profile">
        <div>
            ...
            <form:input type="file" class="form-control-file" id="exampleFormControlFile1" path="profilePicture" name="exampleFormControlFile1"/>
            <form:errors path="profilePicture" class="wrong"  element="p"></form:errors>
        </div>
        <br>

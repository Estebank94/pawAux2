...
<div class="outer-div">
    <div class="inner-div card">
        ...
        <br>
        <button style="margin-bottom:64px;" class="btn btn-primary custom-btn center-horiz" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Volver al Inicio
        </button>
    </div>
</div>
